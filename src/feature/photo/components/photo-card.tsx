...
export function PreviewPhotoCard({
                                     ...
                                     comment,
                                     hashTags,
                                 }: PreviewPhotoCardProps) {
    const [showDetails, setShowDetails] = useState(false);

    const placeDisplay = place?.placeName || cityName;
...
export function PhotoCard({
        ...
        return <PreviewPhotoCard image={image} cityName={cityName} place={place} takenAt={takenAt} comment={comment} hashTags={hashTags} />
}
